        ...
        try:
            ...
            for record in all_records:
                try:
                    ...
                    # PnL-Wert extrahieren - erweiterte Suche basierend auf CSV-Struktur
                    pnl_columns = [
...
def debug_sheets():
    """Debug-Route um Google Sheets Verbindung und Daten zu testen"""
    if 'user' not in session:
        return redirect(url_for('login'))
...
if __name__ == '__main__':
    ...
    app.run(debug=True, host='0.0.0.0', port=10000), '').replace(',', '').replace('€', '').strip()
                    ...
                    # Symbol extrahieren - erweiterte Suche
                    symbol_columns = [
                    ...
                    # Datum extrahieren - erweiterte Suche
                    date_columns = [
                    ...
                    # Side extrahieren - erweiterte Suche
                    side_columns = [
                    ...
                    # Size extrahieren - erweiterte Suche
                    size_columns = [
                    ...
                    # Entry Price extrahieren - erweiterte Suche
                    entry_columns = [
...
if __name__ == '__main__':
    ...
    app.run(debug=True, host='0.0.0.0', port=10000), '').replace(',', '').replace('€', '').strip()
                    ...
                    # Exit Price extrahieren - erweiterte Suche
                    exit_columns = [
...
if __name__ == '__main__':
    os.makedirs('static', exist_ok=True)
    app.run(debug=True, host='0.0.0.0', port=10000), '').replace(',', '').replace('€', ''))
                                    if pnl_val != 0:
